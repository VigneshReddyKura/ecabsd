...
notebook = {
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# ============================================================\n",
    "# CELL 6 — RECOVER BAD GRAPHS (fixed import path)\n",
    "# ============================================================\n",
    ...
    "result = subprocess.run([sys.executable, '-m', 'scripts.recover_graphs'], cwd=WORKDIR)\n",
    "print(result)\n",
    "print('[RECOVERY] Done.')"
   ]
  },
  {
   ...
   "source": [
    ...
    "cfg['model']['version']           = 'v2'    # V2 Baseline Overboost\n",
    "cfg['model']['num_gcn_layers']    = 4       # V2 Baseline\n",
    "cfg['model']['dropout']           = 0.3     # V2 Overboost: slightly reduced dropout\n",
    "cfg['model']['hidden_dim']        = 192     # V2 Overboost: increased capacity\n",
    "cfg['training']['epochs']         = 100\n",
    "cfg['training']['learning_rate']  = 0.0003  # V2 Baseline\n",
    "cfg['training']['loss']           = 'combined'\n",
    "cfg['training']['dice_weight']    = 0.5     # V2 Overboost: prioritize F1 optimization\n",
    "cfg['training']['focal_alpha']    = 0.75    # V2 Overboost: less aggressive minority weighting\n",
    "cfg['training']['warmup_epochs']  = 5       # V2 Overboost: faster warmup\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "process = subprocess.Popen([sys.executable, '-u', 'train.py'], cwd=WORKDIR, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "process = subprocess.Popen([sys.executable, '-u', 'evaluate.py'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)\n",
    "for line in process.stdout:\n",
    "    print(line, end='', flush=True)\n",
    "process.wait()"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "zip_path = '/kaggle/working/ecabsd_v2_overboost_results.zip'\n",
...
with open("ECABSD_V3_Training.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)

print("Generated clean notebook!")
