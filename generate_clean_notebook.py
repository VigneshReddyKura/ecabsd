 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "cfg['model']['num_gcn_layers']    = 4       # V3-lite: fewer layers\n",
    "cfg['model']['dropout']           = 0.2     # V3-lite: lower dropout\n",
    "cfg['model']['hidden_dim']        = 128     # V3-lite: smaller hidden dim\n",
    "cfg['model']['num_cross_attn_layers'] = 2   # V3 Upgrade: cross-attention layers\n",
    "cfg['training']['epochs']         = 100\n",
    "cfg['training']['learning_rate']  = 0.0001  # Lowered LR to prevent NaN in deep GATv2\n",
    "cfg['training']['focal_gamma']    = 2.0     # V3-lite: softer focal loss\n",
    "cfg['training']['gradient_clip']  = 1.0     # V3-lite: clip norm\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "process = subprocess.Popen([sys.executable, '-u', 'train_v3.py'], cwd=WORKDIR, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "process = subprocess.Popen([sys.executable, '-u', 'evaluate_v3.py'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)\n",
    "for line in process.stdout:\n",
    "    print(line, end='', flush=True)\n",
    "process.wait()"
   ]
  },
  {
   ...
   "source": [
    ...
    "else:\n",
    "    print('❌ ERROR: best_model_v3.pt not found! Training failed.')\n",
    "\n",
